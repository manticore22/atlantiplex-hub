...
import LivestreamInterface from './components/LivestreamInterface.jsx'
...
export default function App() {
  ...
  const livestream = typeof window !== 'undefined' ? new URLSearchParams(window.location.search).get('livestream') : null
